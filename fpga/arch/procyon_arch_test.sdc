...
set_input_delay  -clock ext_clk -max 0 [get_ports {SRAM_DQ[*]}]
set_input_delay  -clock ext_clk -min 0 [get_ports {SRAM_DQ[*]}]
set_output_delay -clock ext_clk -max 0 [get_ports {SRAM_DQ[*]}]
set_output_delay -clock ext_clk -min 0 [get_ports {SRAM_DQ[*]}]
set_output_delay -clock ext_clk -max 0 [get_ports {SRAM_ADDR[*]}]
set_output_delay -clock ext_clk -min 0 [get_ports {SRAM_ADDR[*]}]
set_output_delay -clock ext_clk -max 0 [get_ports {SRAM_CE_N}]
set_output_delay -clock ext_clk -min 0 [get_ports {SRAM_CE_N}]
set_output_delay -clock ext_clk -max 0 [get_ports {SRAM_WE_N}]
set_output_delay -clock ext_clk -min 0 [get_ports {SRAM_WE_N}]
set_output_delay -clock ext_clk -max 0 [get_ports {SRAM_OE_N}]
set_output_delay -clock ext_clk -min 0 [get_ports {SRAM_OE_N}]
set_output_delay -clock ext_clk -max 0 [get_ports {SRAM_LB_N}]
set_output_delay -clock ext_clk -min 0 [get_ports {SRAM_LB_N}]
set_output_delay -clock ext_clk -max 0 [get_ports {SRAM_UB_N}]
set_output_delay -clock ext_clk -min 0 [get_ports {SRAM_UB_N}]

set_false_path -from * -to [get_ports {SRAM_DQ[*]}]
set_false_path -from * -to [get_ports {SRAM_ADDR[*]}]
set_false_path -from * -to [get_ports {SRAM_CE_N}]
set_false_path -from * -to [get_ports {SRAM_WE_N}]
set_false_path -from * -to [get_ports {SRAM_OE_N}]
