...
parser.add_argument("-t", "--timeout", default=3, type=int, help="Specify a timeout in seconds to allow an architectural test to run for before it is killed and considered a failed test")
